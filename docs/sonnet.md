...
#### [`VanillaRNN.__init__(hidden_size, activation=<function tanh at 0x7fdf83e9d1e0>, initializers=None, partitioners=None, regularizers=None, name='vanilla_rnn')`](https://github.com/deepmind/sonnet/blob/master/sonnet/python/modules/basic_rnn.py?l=71)<a id="VanillaRNN.__init__" />
