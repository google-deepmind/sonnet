...
class MixedPrecisionClassTest(test_utils.TestCase):
  ...
  def test_float16_mode_variable_eligible_class(self, test_class):
    ...
    d = test_class(x)
    d.check_type = mixed_precision.modes(
        [tf.float32, tf.float16])(d.check_type)
  ...
  def test_float16_mode_nested_eligible_class(self, test_class):
    ...
    d = test_class(z)
    d.check_type_structure = mixed_precision.modes(
        [tf.float32, tf.float16])(d.check_type_structure)
  ...
  def test_float16_mode_eligible_multiple_instances_class(self, test_class):
    ...
    d2 = test_class(x)
    d2.check_type = mixed_precision.modes(
        [tf.float32, tf.float16])(d2.check_type)
  ...
  def test_float16_mode_ineligible_multiple_instances_class(self, test_class):
    ...
    d = test_class(x)
    d.check_type = mixed_precision.modes(
        [tf.float32, tf.bfloat16])(d.check_type)

    d2 = test_class(x)
    d2.check_type = mixed_precision.modes(
        [tf.float32, tf.bfloat16])(d2.check_type)
