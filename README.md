...
- [Training a Little GAN on MNIST](https://colab.research.google.com/github/deepmind/sonnet/blob/v2/examples/mlp_on_mnist.ipynb)
...
```shell
$ pip install "tensorflow-gpu>=2.0.0rc1" --pre
$ pip install "tensorflow-probability>=0.8.0rc0" --pre
